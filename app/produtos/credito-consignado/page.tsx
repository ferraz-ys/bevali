      ...
      <section className="bg-primary py-20">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-white/90 max-w-2xl mx-auto">
            As melhores taxas do mercado para servidores públicos, aposentados e pensionistas do INSS
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              O crédito consignado está disponível para diferentes categorias de trabalhadores e beneficiários
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <p className="text-muted-foreground mb-4">
                Servidores públicos federais, estaduais e municipais com estabilidade.
              </p>
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                  <span className="text-sm">Municipais</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                  <span className="text-sm">BPC/LOAS (consulte condições)</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
              ...
              <h3 className="text-xl font-bold mb-2">Militares</h3>
              <p className="text-muted-foreground mb-4">
                Militares das Forças Armadas e forças auxiliares (PM e Bombeiros).
              </p>
              <ul className="space-y-2">
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                  <span className="text-sm">Forças Armadas</span>
                </li>
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                ...
                <li className="flex items-center">
                  <CheckCircle className="h-4 w-4 text-primary mr-2 flex-shrink-0" />
                  <span className="text-sm">Corpo de Bombeiros</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="max-w-3xl mx-auto">
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                ...
                <AccordionContent>
                  As taxas de juros do crédito consignado variam de acordo com o convênio e a instituição financeira,
                  mas geralmente são as mais baixas do mercado, podendo iniciar em 1,70% ao mês. Na Bevali Promotora,
                  trabalhamos para garantir as melhores condições para nossos clientes.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  O prazo máximo para pagamento do crédito consignado pode chegar a até 84 meses (7 anos), dependendo do
